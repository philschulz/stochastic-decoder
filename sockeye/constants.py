...
CHAR_SYMBOLS = VOCAB_SYMBOLS + [BOW_SYMBOL, TOKEN_SEPARATOR]

ARG_SEPARATOR = ":"

ENCODER_PREFIX = "encoder_"
DECODER_PREFIX = "decoder_"
STOCHASTIC_ENCODER_PREFIX = "stochastic_encoder_"
TWO_SIDED_STOCHASTIC_ENCODER_PREFIX = "two_sided_stochastic_encoder_"
TARGET_ENCODER_PREFIX = "target_encoder_"
BACKWARD_TARGET_ENCODER_PREFIX = "backward_target_encoder_"
...
TARGET_CHAR_EMBEDDING_PREFIX = "target_char_embed_"
WORD_ID_TO_CHAR_ID_EMBEDDING_PREFIX = "word_id_to_char_id_"
...
LATENT_VALUE_NAME = "latent_value"
...
METRICS = [PERPLEXITY, ACCURACY, BLEU, ELBO, NEGELBO]
METRIC_MAXIMIZE = {ACCURACY: True, BLEU: True, PERPLEXITY: False, ELBO: True, NEGELBO: False}
METRIC_WORST = {ACCURACY: 0.0, BLEU: 0.0, PERPLEXITY: np.inf, ELBO: -np.inf, NEGELBO: np.inf}

# sampling
SAMPLER_PREFIX = "sampler_"

# random variables
BERNOULLI_PREFIX = "bernoulli_"
POISSON_PREFIX = "poisson_"
GAUSS_PREFIX = 'gaussian_'
BERNOULLI = "bernoulli"
POISSON = "poisson"
DIAGONAL_GAUSS = "diagonal-gaussian"
FULL_RANK_GAUSS = "full-rank-gaussian"

KL_LOSS = "kl_loss"

INFERENCE_PREFIX = "inference_"

STOCHASTIC_RNN_PREFIX = "stochastic_rnn_"
