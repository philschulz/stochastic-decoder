...
def get_encoder(config: Config, prefix: str = ""):
...
class RecurrentEncoderConfig(Config):
    ...
    :param unidirectional: The lowest RNN layer is unidirectional instead bidirectional.
    """
...
def get_recurrent_encoder(config: RecurrentEncoderConfig, prefix: str = "") -> 'Encoder':
    ...
    :param prefix: The prefix of this Encoder.
